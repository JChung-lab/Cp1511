//This program reads in a 3x3 noughts and crosses (Tic-Tac-Toe) board, stores it in a 2D array and then prints it out. Then it checks if there is a winner for the tic tac toe.
//11/06/2019
